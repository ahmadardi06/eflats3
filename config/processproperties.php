...
if(isset($_POST['submit'])) {
	...
	if ($_POST['id'] == '') {
		...
		header('location: /eflats3/manproperties.php?message=add_new_properties');
	} else {
		...
		header('location: /eflats3/manproperties.php?message=update_properties');
	}
